const DISTRICT_DATA = {
  ...
  "Karnataka": ["Bagalkot", "Bangalore Rural", "Bangalore Urban", "Belgaum", "Bellary", "Bidar", "Chamarajanagar", "Chikkaballapur", "Chikkamagaluru", "Chitradurga", "Dakshina Kannada", "Davanagere", "Dharwad", "Gadag", "Hassan", "Haveri", "Kalaburagi", "Kodagu", "Kolar", "Koppal", "Mandya", "Mysore", "Raichur", "Ramanagara", "Shivamogga", "Tumakuru", "Udupi", "Uttara Kannada", "Vijayapura", "Yadgir"],
...
export default function SelectionForm({
  ...
  const handleStateChange = (e) => {
    ...
    onDistrictChange(null); // Reset district when state changes
  };
  ...
  const isSubmitDisabled = !selectedState || !selectedDistrict || loading;
